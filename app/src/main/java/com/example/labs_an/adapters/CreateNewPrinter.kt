...
import com.example.labs_an.R
import com.example.labs_an.databinding.AddNewDialogBinding

class DialogEditUserNameFragment : DialogFragment(R.layout.add_new_dialog) {
